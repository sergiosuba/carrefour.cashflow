...
{
    public class ChartAccountServiceTestAdd : BaseTest
    {
        ...
        public ChartAccountServiceTestAdd()
        {
        ...
        )
        {
            try
            {
                ...
                _genericRepository.Setup(x => x.AddAsync(It.IsAny<ChartAccount>()));

                //When
                var result = await _chartAccountService.AddAsync(chartAccountDTO);
